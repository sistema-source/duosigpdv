...
uses
  ...
  view_consulta_cliente, view_consulta_municipio, view_consulta_fornecedor, view_mensagem_carregar_dados, view_login, view_consulta_produto, model_paygo_tef1, model_sessao, model_configuracao_inifile,
  model_paygo_tef, model_nfe;
...
begin
  ...
  Application.CreateForm(TModelPayGoTef1, ModelPayGoTef1);
  Application.CreateForm(TModelPayGoTef, ModelPayGoTef);
